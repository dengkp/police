...
- springboot：[https://gitee.com/dp_group/springboot](https://gitee.com/dp_group/springboot)
...
### 项目拓展
- [基于系统参数管理实现动态select控件](https://my.oschina.net/dengkp/blog/1615653)
- [基于ajaxfileupload.js实现文件上传](https://my.oschina.net/dengkp/blog/1615214)
### 技术方案
- 核心框架：SpringBoot
- ORM框架：Mybatis
- 安全框架：Shiro
